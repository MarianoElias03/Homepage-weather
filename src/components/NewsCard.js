    ...
    <div>
      ...
      <div className="start-0 translate-end-x">
        {articles.slice(0,3).map((article, index) => (
          <a href={article.webUrl} target="_blank" rel="noopener noreferrer" className="card m-3">
            <div class="row g-0">
              <div className="col-md-4">
                <img src={article.fields.thumbnail} alt={article.webTitle} className="img-fluid rounded-start"/>
              </div>
